RSpec.describe 'reject pattern' do
  ...
  it 'removes vowels' do
    ...
    letters.each do |letter| 
      remaining << letter if !letter.start_with?('a','e','i','o','u','y')
    end
  ...
  it 'removes numbers' do
    ...
    elements.each do |ele|
      not_numbers << ele if ele.is_a?(String)
    end
  ...
  it 'removes floats' do
    ...
    not_numbers = []
    elements.each do |ele|
      not_numbers << ele if !ele.is_a?(Float)
    end
  ...
  it 'removes animals starting with vowels' do
    ...
    remaining = []
    animals.each do |animal|
      remaining << animal if !animal.start_with?('a','e','i','o','u')
    end
  ...
  it 'removes arrays' do
    ...
    remaining = []
    elements.each do |ele|
      remaining << ele unless ele.is_a?(Array)
    end
  ...
  it 'removes hashes' do
    ...
    remaining = []
    elements.each do |ele|
      remaining << ele unless ele.is_a?(Hash)
    end
